...
func CLSIDFromString(str string) (clsid *ole.GUID, err error) {
	var guid ole.GUID
...
func StringFromCLSID(clsid *ole.GUID) (str string, err error) {
	var p *uint16
	hr, _, _ := procStringFromCLSID.Call(uintptr(unsafe.Pointer(clsid)), uintptr(unsafe.Pointer(&p)))
	if hr != 0 {
		err = NewError(hr)
	}
	str = ole.LpOleStrToString(p)
	return
}

// IIDFromString returns GUID from program ID.
func IIDFromString(progId string) (clsid *ole.GUID, err error) {
	var guid ole.GUID
...
func StringFromIID(iid *ole.GUID) (str string, err error) {
	var p *uint16
...
func CreateInstance(clsid *ole.GUID, iid *ole.GUID) (unk *ole.IUnknown, err error) {
	if iid == nil {
...
func GetActiveObject(clsid *ole.GUID, iid *ole.GUID) (unk *ole.IUnknown, err error) {
	if iid == nil {
		iid = ole.IID_IUnknown
	}
...
func GetObject(programID string, bindOpts *BindOpts, iid *ole.GUID) (unk *ole.IUnknown, err error) {
	if bindOpts != nil {
...
func VariantInit(v *ole.VARIANT) (err error) {
...
func VariantClear(v *ole.VARIANT) (err error) {
...
func CreateStdDispatch(unk *ole.IUnknown, v uintptr, ptinfo *ole.IUnknown) (disp *ole.IDispatch, err error) {
...
func CreateDispTypeInfo(idata *ole.INTERFACEDATA) (pptinfo *ole.IUnknown, err error) {
...
func GetMessage(msg *ole.Msg, hwnd uint32, MsgFilterMin uint32, MsgFilterMax uint32) (ret int32, err error) {
...
func DispatchMessage(msg *ole.Msg) (ret int32) {
