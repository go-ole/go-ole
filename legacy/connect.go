...
type Connection struct {
	Object *ole.IUnknown // Access COM
}
...
func (c *Connection) Create(progId string) (err error) {
	...
	unknown, err := CreateInstance(clsid, ole.IID_IUnknown)
	if err != nil {
		return
	}
	c.Object = unknown
...
func (c *Connection) Dispatch() (object *Dispatch, err error) {
	dispatch, err := c.Object.QueryInterface(ole.IID_IDispatch)
	if err != nil {
		return
	}
...
type Dispatch struct {
	Object *ole.IDispatch // Dispatch object.
}

// Call method on IDispatch with parameters.
func (d *Dispatch) Call(method string, params ...interface{}) (result *ole.VARIANT, err error) {
...
func (d *Dispatch) MustCall(method string, params ...interface{}) (result *ole.VARIANT) {
	id, err := d.GetId(method)
	if err != nil {
		panic(err)
	}
...
func (d *Dispatch) Get(name string, params ...interface{}) (result *ole.VARIANT, err error) {
	id, err := d.GetId(name)
	if err != nil {
		return
	}
...
func (d *Dispatch) MustGet(name string, params ...interface{}) (result *ole.VARIANT) {
	id, err := d.GetId(name)
	if err != nil {
		panic(err)
	}
...
func (d *Dispatch) Set(name string, params ...interface{}) (result *ole.VARIANT, err error) {
	id, err := d.GetId(name)
	if err != nil {
		return
	}
...
func (d *Dispatch) MustSet(name string, params ...interface{}) (result *ole.VARIANT) {
	id, err := d.GetId(name)
	if err != nil {
		panic(err)
	}
...
func (d *Dispatch) Invoke(id int32, dispatch int16, params []interface{}) (result *ole.VARIANT, err error) {
	if len(params) < 1 {
