...
func MarshalSafeArray[T any]() *SafeArray {
	return &SafeArray{}
}

// UnmarshalSafeArray converts SafeArray to Go array slice from COM/OLE transport.
func UnmarshalSafeArray[T any](sa *SafeArray) T {
...
// Release releases the memory locked by AccessData() raw array.
//
// AKA: SafeArrayUnaccessData in Windows API.
func (sa *SafeArray[T]) Release() (err error) {
